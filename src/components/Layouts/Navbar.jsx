...
const Navbar = () => {
  ...
  return (
    <>
      <AppBar
        position="sticky"
        sx={{ backgroundColor: mode === "dark" ? "#000000" : "white" }}
      >
        <StyledToolbar>
          <StyledLogo>
          ...
          <Icons>
            <Box
              ...
              to="/"
              sx={{
                padding: { sm: "0 0.3rem", md: "0 0.8rem" },
              }}
            >
              <svg
                aria-label="Home"
            ...
            >
              <Badge badgeContent={4} color="error" max={10} overlap="circular">
                <svg
        ...
        <Paper
          ...
          sx={{
            ...
            backgroundColor: mode === "dark" ? "#3B3B3B" : "#fafafa",
            color: mode === "dark" ? "#fafafa" : "#262626",
            position: "fixed",
          }}
        >
